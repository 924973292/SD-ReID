...
_C.MODEL.BACKBONE.CAMERA_NUM = 13
...
# ---------------------------------------------------------------------------- #
# Satble Diffusion(SD) options
# ---------------------------------------------------------------------------- #

_C.MODEL.SDMODEL = CN()

_C.MODEL.SDMODEL.FIRST_STAGE_CONFIG = CN()
_C.MODEL.SDMODEL.FIRST_STAGE_CONFIG.PRETRAINED_PATH = ""
_C.MODEL.SDMODEL.U_COND_PERCENT = 0.2
_C.MODEL.SDMODEL.U_COND_DOWN_BLOCK_GUIDANCE = False
_C.MODEL.SDMODEL.U_COND_UP_BLOCK_GUIDANCE = False
_C.MODEL.SDMODEL.TRAIN_STEP = 200

_C.MODEL.SDMODEL.VIEW_NUM = 2
_C.MODEL.SDMODEL.MOEMNTUM = 0.8

_C.MODEL.SDMODEL.SCHEDULER_CONFIG = CN()
_C.MODEL.SDMODEL.SCHEDULER_CONFIG.NAME = "ddpm"
_C.MODEL.SDMODEL.SCHEDULER_CONFIG.PRETRAINED_PATH = ""
_C.MODEL.SDMODEL.SCHEDULER_CONFIG.CUBIC_SAMPLING = True

_C.MODEL.SDMODEL.UNET_CONFIG = CN()
_C.MODEL.SDMODEL.UNET_CONFIG.PRETRAINED_PATH = ""
_C.MODEL.SDMODEL.UNET_CONFIG.TRAINABLE_BLOCK_IDX = [11, 10, 9, 8, 7, 6, 5, 4, 3]
_C.MODEL.SDMODEL.UNET_CONFIG.TRAIN_SELF_ATTN_Q = False
_C.MODEL.SDMODEL.UNET_CONFIG.TRAIN_SELF_ATTN_K = False
_C.MODEL.SDMODEL.UNET_CONFIG.TRAIN_SELF_ATTN_V = False
_C.MODEL.SDMODEL.UNET_CONFIG.TRAIN_CROSS_ATTN_Q = False
_C.MODEL.SDMODEL.UNET_CONFIG.TRAIN_CROSS_ATTN_K = True
_C.MODEL.SDMODEL.UNET_CONFIG.TRAIN_CROSS_ATTN_V = True

_C.MODEL.SDMODEL.CON_LEARNER_CONFIG = CN()
_C.MODEL.SDMODEL.CON_LEARNER_CONFIG.N_CTX = 1
_C.MODEL.SDMODEL.CON_LEARNER_CONFIG.CTX_DIM = 768
_C.MODEL.SDMODEL.CON_LEARNER_CONFIG.DEPTH = 8
_C.MODEL.SDMODEL.CON_LEARNER_CONFIG.HEADS = 24
_C.MODEL.SDMODEL.CON_LEARNER_CONFIG.POSE_QUERY = False

_C.MODEL.SDMODEL.CON_LEARNER_CONFIG.IN_CHANNEL = 320
_C.MODEL.SDMODEL.CON_LEARNER_CONFIG.OUT_CHANNELS = [320, 640, 1280]


_C.MODEL.SDMODEL.CON_LEARNER_CONFIG.SWITCH = 0
_C.MODEL.SDMODEL.CON_LEARNER_CONFIG.SWITCH2 = 0
...
_C.MODEL.LOSSES.CE.VIEW_ID = True
_C.MODEL.LOSSES.CE.VIEW_OREG = True
...
_C.SOLVER.DECAY_EPOCHS = [50]
_C.SOLVER.OVERRIDE_LR = 0.
...
# SD
_C.TEST.SDMODEL = CN()
_C.TEST.SDMODEL.DOWN_BLOCK_GUIDANCE_SCALE = 2.0
_C.TEST.SDMODEL.FULL_GUIDANCE_SCALE = 2.0
_C.TEST.SDMODEL.NUM_INFERENCE_STEPS = 50
_C.TEST.SDMODEL.INVERSE_TYPE = 'uc_full'
